...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5635565892:AAEGrTYxTmMeASUPUebfCVyWx5xb5FA5N7M")
...
HEROKU_APP_NAME = os.environ.get("HEROKU_APP_NAME", "nakflixsharing1bot")
